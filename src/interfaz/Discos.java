...
public class Discos extends JFrame {
	...
	public static String texto = "Buscar en Discos";
	...
	public Discos() {
		...
		lblGoTo.setBounds(46, 112, 66, 22);
		...
		JLabel lblNombre = new JLabel("Discos:");
		lblNombre.setBounds(255, 16, 82, 23);
