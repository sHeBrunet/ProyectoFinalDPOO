...
public class TarjetaDeVideo extends JFrame {
	...
	public static String texto = "Buscar en Tarjetas de Video";
	...
	public TarjetaDeVideo() {
		...
		final JButton btnTarjetasDeVideo = new JButton("Motherboards");
		...
		btnTarjetasDeVideo.setBounds(0, 34, 150, 23);
		...
		JLabel lblNombre = new JLabel("Tarjetas de Video");
		lblNombre.setBounds(200, 16, 192, 23);
