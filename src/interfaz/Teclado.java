...
public class Teclado extends JFrame {
	...
	public static String texto = "Buscar en Teclados";
	public static String textoAux = "";
	private JButton btnCerrarSeccin;
	...
	public Teclado() {
		...
		panelGoTo.setBounds(0, 145, 150, 488);
		panelIzq.add(panelGoTo);
		panelGoTo.setBackground(new Color(255, 255, 255));
		panelGoTo.setLayout(null);
		
		final JButton btnMicro = new JButton("Microprocesadores");
		btnMicro.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		btnMicro.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				Microprocesadores micros = new Microprocesadores();
		...
		btnMicro.setBounds(0, 68, 150, 23);
		panelGoTo.add(btnMicro);
		...
		btnMemoriasRam.setBounds(0, 102, 150, 23);
		...
		btnTarjetasDeVideo.setBounds(0, 136, 150, 23);
		...
		btnHddsdd.setBounds(0, 170, 150, 23);
		...
		btnFuente.setBounds(0, 204, 150, 23);
		...
		btnMonitor.setBounds(0, 238, 150, 23);
		panelGoTo.add(btnMonitor);
		
		final JButton btnTeclado = new JButton("Motherboards");
		...
		btnTeclado.setBounds(0, 34, 150, 23);
		...
		btnCerrarSeccin = new JButton("Cerrar secci\u00F3n");
		btnCerrarSeccin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int i = JOptionPane.showConfirmDialog(null, "¿Seguro que quiere cerrar sección?");
				if(i == 0) {
				setVisible(false);
		...
		btnCerrarSeccin.setForeground(new Color(255, 0, 0));
		btnCerrarSeccin.setFont(new Font("Tahoma", Font.PLAIN, 13));
		btnCerrarSeccin.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				btnCerrarSeccin.setBorder(new MatteBorder(2, 2, 2, 2, (Color) new Color(135, 206, 235)));
			}
			public void mouseExited(MouseEvent e) {
				btnCerrarSeccin.setBorder(null);
			}
		});
		btnCerrarSeccin.setFocusable(false);
		btnCerrarSeccin.setBorder(null);
		btnCerrarSeccin.setBackground(Color.WHITE);
		btnCerrarSeccin.setBounds(0, 399, 150, 23);
		panelGoTo.add(btnCerrarSeccin);
		...
		JLabel lblNombre = new JLabel("Teclados:");
		lblNombre.setBounds(238, 16, 121, 23);
