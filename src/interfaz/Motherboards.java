...
public class Motherboards extends JFrame {
	...
	public static String texto = "Buscar en Motherboards";
	...
	public Motherboards() {
		...
		btnMicro.setBounds(0, 34, 150, 23);
		...
		JLabel lblNombre = new JLabel("Motherboards:");
		lblNombre.setBounds(204, 16, 179, 23);
