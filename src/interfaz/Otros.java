...
public class Otros extends JFrame {
	...
	public static String texto = "Buscar en Otros";
	...
	public Otros() {
		...
		btnMicro.setBounds(0, 69, 150, 23);
		...
		btnMemoriasRam.setBounds(0, 103, 150, 23);
		...
		btnTarjetasDeVideo.setBounds(0, 137, 150, 23);
		...
		btnHddsdd.setBounds(0, 171, 150, 23);
		...
		btnFuente.setBounds(0, 205, 150, 23);
		...
		btnMonitor.setBounds(0, 239, 150, 23);
		...
		btnTeclado.setBounds(0, 273, 150, 23);
		...
		btnMouse.setBounds(0, 307, 150, 23);
		...
		btnChasis.setBounds(0, 375, 150, 23);
		...
		btnBocinas.setBounds(0, 341, 150, 23);
		...
		btnMb.setBackground(new Color(255, 255, 255));
		...
		JLabel lblNombre = new JLabel("Otros:");
		lblNombre.setBounds(260, 16, 70, 23);
