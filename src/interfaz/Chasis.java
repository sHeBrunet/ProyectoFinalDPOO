...
public class Chasis extends JFrame {
	...
	public static String texto = "Buscar en Chasis";
	...
	public Chasis() {
		...
		btnTeclado.setBounds(0, 272, 150, 23);
		...
		btnMouse.setBounds(0, 306, 150, 23);
		...
		panelPrincipal.setBounds(162, 130, 638, 550);
		PanelPrincipal.add(panelPrincipal);
		panelPrincipal.setLayout(new GridLayout(10, 0, 0, 0));
		...
		panelPrincipal.add(btnAnuncio1);
		...
		panelPrincipal.add(btnAnuncio2);
		...
		panelPrincipal.add(btnAnuncio3);
		...
		panelPrincipal.add(btnAnuncio4);
		...
		panelPrincipal.add(btnAnuncio5);
		...
		panelPrincipal.add(btnAnuncio6);
		...
		panelPrincipal.add(btnAnuncio7);
		...
		panelPrincipal.add(btnAnuncio8);
		...
		panelPrincipal.add(btnAnuncio9);
		...
		panelPrincipal.add(btnAnuncio10);
		...
		JLabel lblNombre = new JLabel("Chasis:");
		lblNombre.setBounds(255, 16, 79, 23);
