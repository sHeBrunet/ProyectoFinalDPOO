...
public class MemoriasRAM extends JFrame {
	...
	public static String texto = "Buscar en Memorias RAM";
	...
	public MemoriasRAM() {
		...
		lblGoTo.setBounds(45, 112, 66, 22);
		...
		JLabel lblNombre = new JLabel("Memorias RAM:");
		lblNombre.setBounds(217, 16, 158, 23);
